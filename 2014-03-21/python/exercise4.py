...
gradino1_vertici = [ [0,0], [5,0], [5,3], [0,3] ];
...
gradino2=T([1,3])([-1,1])(gradino2)

gradino3_vertici = [ [2,2], [7,2], [7,5], [2,5] ];
gradino3_num_lati = [range(1,5)] 
gradino3_2D = MKPOL([gradino3_vertici, gradino3_num_lati, None])
gradino3 = PROD([gradino3_2D, Q(1)])
gradino3=T([1,3])([-2,2])(gradino3)

gradino4_vertici = [ [3,3], [8,3], [8,6], [3,6] ];
gradino4_num_lati = [range(1,5)] 
gradino4_2D = MKPOL([gradino4_vertici, gradino4_num_lati, None])
