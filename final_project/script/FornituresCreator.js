...
var arredoCamera1=new THREE.Object3D();
  ...
  lettoCamera1= createObject('juniorBed.obj','juniorBed.mtl',0.01,0.01,0.01,1.2,2.3,0.1,Math.PI/2)
  comodinoCamera1= createObject('bedsideTable.obj','bedsideTable.mtl',0.01,0.01,0.01,0.2,1.5,0.2,Math.PI/2)
  scrivaniaCamera1= createObject('officeTable.obj','officeTable.mtl',0.015,0.01,0.01,1.55,0.5,0.1,Math.PI)
  armadioCamera1=createObject('wardrobe.obj','wardrobe.mtl',0.013,0.01,0.01,4.2,1.5,0.1,-Math.PI/2)
  libreriaCamera1=createObject('full-bookcase.obj', 'full-bookcase.mtl',0.01,0.01,0.01,3.8,0.2,1,Math.PI)
  arredoCamera1.add(lettoCamera1)
  arredoCamera1.add(comodinoCamera1)
  arredoCamera1.add(scrivaniaCamera1)
  arredoCamera1.add( armadioCamera1)
  arredoCamera1.add( libreriaCamera1)
...
var  arredoSalaPranzo= new THREE.Object3D();
  ...
  tavolo=createObject('table_wood_and_iron.obj','table_wood_and_iron.mtl',0.015,0.015,0.015,2,1.8,0.3,Math.PI/2);
  arredoSalaPranzo.add(tavolo)
