...
var hole4 = new THREE.Path([new THREE.Vector2(1.58,2.4),new THREE.Vector2(0.49,2.4),new THREE.Vector2(0.49,1),
 ...
 var hole5 = new THREE.Path([new THREE.Vector2(1.502,2.405),new THREE.Vector2(0.40,2.405),new THREE.Vector2(0.40,0),
      new THREE.Vector2(1.502,0)]);


 var hole6 = new THREE.Path([new THREE.Vector2(1.6,2.405),new THREE.Vector2(0.20,2.405),new THREE.Vector2(0.20,0),
