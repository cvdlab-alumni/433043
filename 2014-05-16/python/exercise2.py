...
scaleDX2=CUBOID([3.1,2.5,2.2])
scaleDX2=T([1,2])([22.3,-5.6])(scaleDX2)

scaleDX3=CUBOID([3.1,2.5,1.6])
...
siepe2=T([1,2,3])([-4.7,15.8,2.9])(siepe2)
siepe2=COLOR(rgbToPlasmColor([85,104	,5]))(siepe2)


siepe3=STRUCT(NN(14)([Tp, pianta]))
siepe3=T([1,2,3])([-4.7,3,1.2])(siepe3)
siepe3=COLOR(rgbToPlasmColor([85,104	,5]))(siepe3)

pianta1=T([1,2,3])([-4.7,3,1.4])(pianta)
pianta2=T([1,2,3])([-4.7,3.8,1.6])(pianta)
pianta3=T([1,2,3])([-4.7,4.4,1.8])(pianta)
pianta4=T([1,2,3])([-4.7,5,1.9])(pianta)
pianta5=T([1,2,3])([-4.7,5.6,2.1])(pianta)
pianta6=T([1,2,3])([-4.7,6.2,2.2])(pianta)
pianta7=T([1,2,3])([-4.7,6.8,2.3])(pianta)
pianta8=T([1,2,3])([-4.7,7.4,2.4])(pianta)
pianta9=T([1,2,3])([-4.7,8,2.6])(pianta)
pianta10=T([1,2,3])([-4.7,8.6,2.8])(pianta)
