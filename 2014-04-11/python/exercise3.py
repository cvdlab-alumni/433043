...
villa = STRUCT([casa,prato1])
Tc = T(1)(13)
Tz = T(3)(10)
#Ripezione della casa. Complesso di case#
complesso=STRUCT(NN(2)([Tz, STRUCT(NN(3)([Tc, villa]))]))
complesso=ROTATE([2,3])(PI/2)(complesso)
complesso=ROTATE([1,2])(PI)(complesso)
complesso=T([1,2,3])([150,50,1])(complesso)


#Creo un secondo complesso

piano_vertici = [ [0,0], [40,0], [0,40], [40,40] ];
...
T1=T(1)(20)
T2=T(2)(20)
complesso2_temp=STRUCT(NN(2)([T1, STRUCT(NN(2)([T2, palazzo_temp]))]))
complesso2_temp=T([1,2,3])([-18,-18,1])(complesso2_temp)
